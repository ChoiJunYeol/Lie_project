...
public class Membership1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText PW_Text = (EditText)findViewById(R.id.pw_ed);
        final EditText RE_PW_Text = (EditText)findViewById(R.id.re_pw_ed);
         ...
         btnOK.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 if (Email_Text.getText().toString().replace(" ", "").equals("")
                         || PW_Text.getText().toString().replace(" ", "").equals("")
                         || Name_Text.getText().toString().replace(" ", "").equals("")
                         || RE_PW_Text.getText().toString().replace(" ", "").equals("")) {

                     Toast.makeText(getApplicationContext(), "빈칸이 존재합니다.", Toast.LENGTH_LONG).show();

                 } else if (Email_Text.getText().toString().contains(" ")
                         || PW_Text.getText().toString().contains(" ")
                         || Name_Text.getText().toString().contains(" ")) {
                     ...
                     ProgressDialog dialog = ProgressDialog.show(Membership1.this, "", "회원 등록중...", true);
                     new Thread(new Runnable() {
                         public void run() {
                             HttpPost(Email_Text.getText().toString(), Name_Text.getText().toString(), type, sex_checked,PW_Text.getText().toString());
                         }
                     }).start();
    ...
    private void HttpPost(String email,String name,String type,String sex,String pw) {
        ...
        try {
            ...
            nameValues.add(new BasicNameValuePair("pw", pw));
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert_confirm = new AlertDialog.Builder(Membership1.this);
